 ...
 */
class JsonUserProvider implements UserProviderInterface, PasswordUpgraderInterface
{
    public function __construct(private ContaoFramework $framework, private $userClass)
    {
